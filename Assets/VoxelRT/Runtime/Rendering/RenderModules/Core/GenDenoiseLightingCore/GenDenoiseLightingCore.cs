...
namespace VoxelRT.Runtime.Rendering.RenderModules.Core
{
    ...
    {
        private const string TemporalShaderName = "Hidden/VoxelRT/Rendering/RtLightingTemporalDenoise";
        private const string SpatialShaderName = "Hidden/VoxelRT/Rendering/RtLightingSpatialDenoise";
        ...
        public void RecordDenoise(CommandBuffer commandBuffer, in RenderData renderData)
        {
            ...
            commandBuffer.GetTemporaryRT(
                VoxelRtLightingIds.AfterTemporalTextureId,
                CreateTextureDescriptor(renderData.Width, renderData.Height, ResolveOutputFormat()),
                FilterMode.Bilinear);
            commandBuffer.GetTemporaryRT(
                VoxelRtLightingIds.AfterSpatialTextureId,
                CreateTextureDescriptor(renderData.Width, renderData.Height, ResolveOutputFormat()),
                FilterMode.Bilinear);
            ...
            commandBuffer.Blit(
                ...
                VoxelRtLightingIds.GetRenderTargetIdentifier(VoxelRtLightingTexture.AfterTemporal),
                _temporalMaterial);
            ...
            commandBuffer.Blit(
                VoxelRtLightingIds.GetRenderTargetIdentifier(VoxelRtLightingTexture.AfterTemporal),
                VoxelRtLightingIds.GetRenderTargetIdentifier(VoxelRtLightingTexture.AfterSpatial),
                _spatialMaterial);
            commandBuffer.SetGlobalTexture(
                VoxelRtLightingIds.AfterSpatialTextureId,
                VoxelRtLightingIds.GetRenderTargetIdentifier(VoxelRtLightingTexture.AfterSpatial));
        ...
        public void ReleaseTemporaryTargets(CommandBuffer commandBuffer)
        {
            ...
            commandBuffer.ReleaseTemporaryRT(VoxelRtLightingIds.AfterTemporalTextureId);
            commandBuffer.ReleaseTemporaryRT(VoxelRtLightingIds.AfterSpatialTextureId);
        }
        ...
        private void UpdateHistoryTextures(CommandBuffer commandBuffer, CameraHistoryState historyState)
        {
            ...
            commandBuffer.CopyTexture(
                VoxelRtGbufferIds.GetRenderTargetIdentifier(VoxelRtGbufferTexture.Depth),
                new RenderTargetIdentifier(historyState.DepthTexture));
            commandBuffer.CopyTexture(
                VoxelRtGbufferIds.GetRenderTargetIdentifier(VoxelRtGbufferTexture.Normal),
