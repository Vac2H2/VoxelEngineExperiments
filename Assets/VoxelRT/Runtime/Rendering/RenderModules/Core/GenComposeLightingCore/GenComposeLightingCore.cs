...
namespace VoxelRT.Runtime.Rendering.RenderModules.Core
{
    ...
    {
        private const string DefaultShaderName = "Hidden/VoxelRT/Rendering/RtLightingCompose";
        ...
        public void RecordCompose(CommandBuffer commandBuffer, in RenderData renderData)
        {
            ...
            commandBuffer.GetTemporaryRT(
                VoxelRtLightingIds.FinalColorTextureId,
            ...
            commandBuffer.Blit(
                ...
                VoxelRtLightingIds.GetRenderTargetIdentifier(VoxelRtLightingTexture.FinalColor),
                _runtimeMaterial);
        ...
        public void ReleaseTemporaryTargets(CommandBuffer commandBuffer)
        {
            ...
            commandBuffer.ReleaseTemporaryRT(VoxelRtLightingIds.FinalColorTextureId);
        }
