...
{
    [CreateAssetMenu(
        menuName = "VoxelExperiments/Rendering/Render Modules/RtLighting Module",
        fileName = "RtLightingModule")]
    public sealed class RtLightingModule : VoxelRenderPipelineModule
    {
        private static readonly int ScalarPreviewTextureId = Shader.PropertyToID("_VoxelExperimentsScalarPreview");
        ...
        private static RenderTargetIdentifier ResolvePreviewSource(PreviewTarget previewTarget)
        {
            ...
            {
                PreviewTarget.SunLight => VoxelExperimentsSunLightIds.GetRenderTargetIdentifier(),
                PreviewTarget.LocalLight => VoxelExperimentsLocalLightIds.GetRenderTargetIdentifier(),
                PreviewTarget.LightingRaw => VoxelExperimentsLightingIds.GetRenderTargetIdentifier(VoxelExperimentsLightingTexture.Raw),
                PreviewTarget.LightingAfterTemporal => VoxelExperimentsLightingIds.GetRenderTargetIdentifier(VoxelExperimentsLightingTexture.AfterTemporal),
                PreviewTarget.LightingAfterSpatial => VoxelExperimentsLightingIds.GetRenderTargetIdentifier(VoxelExperimentsLightingTexture.AfterSpatial),
                PreviewTarget.FinalColor => VoxelExperimentsLightingIds.GetRenderTargetIdentifier(VoxelExperimentsLightingTexture.FinalColor),
                PreviewTarget.Albedo => VoxelExperimentsGbufferIds.GetRenderTargetIdentifier(VoxelExperimentsGbufferTexture.Albedo),
                ...
                _ => VoxelExperimentsAoIds.GetRenderTargetIdentifier(),
            };
        }
    }
}
