...
namespace VoxelExperiments.Runtime.Rendering.RenderModules.Core
{
    ...
    public sealed class GenLocalLightCore : IDisposable
    {
            ...
            in RenderData renderData)
        {
            ...
            commandBuffer.SetRayTracingTextureParam(
                rayTracingShader,
                VoxelExperimentsLocalLightIds.LocalLightTextureId,
                VoxelExperimentsLocalLightIds.GetRenderTargetIdentifier());
        ...
        public void ReleaseTemporaryTargets(CommandBuffer commandBuffer)
        {
            ...
            commandBuffer.ReleaseTemporaryRT(VoxelExperimentsLocalLightIds.LocalLightTextureId);
        }
