...
using VoxelExperiments.Runtime.Rendering.RenderModules;

namespace VoxelExperiments.Runtime.Rendering.RenderPipeline
{
    [CreateAssetMenu(menuName = "VoxelExperiments/Rendering/Render Pipeline Asset", fileName = "VoxelRenderPipelineAsset")]
