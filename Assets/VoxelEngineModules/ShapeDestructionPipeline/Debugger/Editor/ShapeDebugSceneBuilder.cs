...
{
    public static class ShapeDebugSceneBuilder
    {
        private const string ScenePath = "Assets/Scenes/Shape Debug.unity";

        [MenuItem("VoxelEngine/Shape/Rebuild Shape Debug Scene")]
        public static void RebuildScene()
        {
            Scene scene = EditorSceneManager.NewScene(NewSceneSetup.EmptyScene, NewSceneMode.Single);
            scene.name = "Shape Debug";

            Camera camera = CreateCamera();
            CreateSun();
            CreateShapeDebugger(camera);
        ...
        [Shortcut("VoxelEngine/Shape/Rebuild Shape Debug Scene")]
        ...
        private static Camera CreateCamera()
        {
            ...
            cameraObject.transform.position = new Vector3(34.0f, 26.0f, -42.0f);
            LookAt(cameraObject.transform, new Vector3(8.0f, 8.0f, 8.0f));
            return camera;
        }
        ...
        private static void TryAddComponent(GameObject gameObject, string typeName)
        {
            ...
            {
                Debug.LogWarning($"Could not find component type '{typeName}' while building the Shape Debug scene.");
                return;
            }
        ...
        private static void CreateShapeDebugger(Camera camera)
        {
            GameObject debuggerObject = new GameObject("Shape Debugger");
            ...
            ShapeDebugger debugger = debuggerObject.AddComponent<ShapeDebugger>();
            debugger.Configure(
                camera,
                shapeCapacity: 32,
