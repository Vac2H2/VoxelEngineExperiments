...
#
get_filename_component(filename "C:/Apps/Unity/Projects/VoxelEngineExperiments/Plugins/NRDPlugin/build/_deps/nri-tmp/v178.zip" ABSOLUTE)
get_filename_component(directory "C:/Apps/Unity/Projects/VoxelEngineExperiments/Plugins/NRDPlugin/build/_deps/nri-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nri${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nri${i}")
