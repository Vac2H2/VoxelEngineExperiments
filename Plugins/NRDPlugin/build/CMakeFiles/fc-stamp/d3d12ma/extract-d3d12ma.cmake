...
#
get_filename_component(filename "C:/Apps/Unity/Projects/VoxelEngineExperiments/Plugins/NRDPlugin/build/_deps/d3d12ma-tmp/c06cd9a6ec4578016aadf650af104c4055ec609a.zip" ABSOLUTE)
get_filename_component(directory "C:/Apps/Unity/Projects/VoxelEngineExperiments/Plugins/NRDPlugin/build/_deps/d3d12ma-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-d3d12ma${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-d3d12ma${i}")
